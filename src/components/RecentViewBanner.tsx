...
function RecentViewBanner() {
    ...
    return (
        <div className="ml-auto mr-0 flex flex-col items-center border-gray-200 border rounded-md px-4 py-3 w-36 h-fit gap-3">
            <div className="font-semibold text-base">최근에 본 문제집</div>
